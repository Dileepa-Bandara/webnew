...
if (isset($_GET['current_user_id'])) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            header("Location:../pages/user.php?error_user_notfound");
        }
    } else {
        header("Location:../pages/user.php?error_user_notfound");
    }
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($newCompanyName)) {
        ...
        if ($result) {
            echo "update success";
            header('Location:../pages/user.php?error_query_Success');
        } else {
            echo "failed.";
            header("Location:../pages/user.php?error_query_failed");
        }
    }
        ...
        <div class="register-form">
            <form action="./adminEdit.php" method="post">
                ...
                ">Category</label>
                    ...
                    <button><a href="./../pages/user.php" style="color:white;text-decoration:none;">Back</a></button>
                </div>
            </form>
        </div>
    </div>
